...
Telegram-бот с **GPT-чатом, генерацией картинок через DALL·E и менеджером задач**.  
Полностью асинхронный, чистый и масштабируемый код, готовый к GitHub.
